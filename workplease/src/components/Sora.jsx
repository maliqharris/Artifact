...
const Sora = () => {
  ...
  const materials = useLoader(
    MTLLoader,
    "src/objects/PlayStation 2 - Kingdom Hearts - Sora/Sora_KH1/Sora_KH1.mtl"
  );
  const fbx = useLoader(
    OBJLoader,
    "src/objects/PlayStation 2 - Kingdom Hearts - Sora/Sora_KH1/Sora_KH1.obj",
    (loader) => {
      materials.preload();
  ...
  const handleDownloadFile = () => {
    const filePath = "src/objects/PlayStation 2 - Kingdom Hearts - Sora.zip"; // Replace with the actual path to the file you want to download
    const link = document.createElement("a");
    link.href = filePath;
    link.download = "Sora.zip"; // Replace "filename" with the desired name of the downloaded file
    link.click();
    playSound();
  };
